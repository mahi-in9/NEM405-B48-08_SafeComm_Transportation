...
export declare const getAllVehicles: (_req: AuthRequest, res: Response) => Promise<void>;
export declare const getVehicleById: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
